...
${URL}`,
  ...
  { slug:'stmt-re-google', ground:'g-accent',
    ...
    portrait:{ html:`Bookmark this &mdash;<br>2,262 tools<br>is a lot to<br>${A('re-Google')}.` },
...
${URL}`,
  ...
  { slug:'stmt-mega-hits', ground:'g-ink bloom',
    ...
    portrait:{ html:`Old mega-hits<br>don't<br>${A('automatically')}<br>win.` },
    size:'d-lg', measure:18,
...
${URL}`,
  ...
  { slug:'stmt-tagline', ground:'g-ink bloom',
    ...
    portrait:{ html:`Find better<br>tools.<br>${A('Create better<br>work.')}` },
...
${URL}/weekly-drip`,
  ...
  { slug:'shot-drip-cards', ground:'g-paper', shot:'cv-drip-cards.png',
    ...
    portrait:{ zoom:152, oy:-235, ox:'50%' },
